        ...
        <span v-if="profile.distanceInKm" class="distance">
          ...
          <dd>
            ...
            <span
              ...
              class="user-match"
            >sejauh {{ textDistance }}</span>
            <template v-else>sejauh {{ textDistance }}</template>
            di {{ profile.city }}
          </dd>
        </span>
...
<div id="team-members">
  <div class="team">
    ...
    <p v-if="errorGettingLocation" class="tip">
      Terjadi kesalahan saat hendak mendeteksi lokasi.
    </p>

    <p>
      Pengembangan Vue dan ekosistemnya dipandu oleh tim internasional, beberapa ditampilkan di bawah:      
    </p>

    <p v-if="userPosition" class="success">
      Diurutkan berdasarkan jarak ke lokasi anda.      
    </p>
  ...
  <div class="team">
    ...
    <p>
      Kita hormati beberapa anggota tim inti yang sudah tidak aktif dan sudah memberikan kontribusi yang berharga sebelumnya.      
    </p>
  ...
  <div class="team">
    <h2 id="community-partners">
      ...
      >
        ...
        <template v-else>
          <i class="fa fa-map-marker"></i>
          <span>temukan di sekitar saya</span>
        </template>
      </button>
    </h2>
    ...
    <p>
      Beberapa anggota komunitas Vue sudah memberikan kontribusi yang sangat besar, mereka berhak untuk disebutkan secara khusus. Kami sudah berhubungan dekat dengan rekan-rekan penting ini; sampai kami sering berkordinasi untuk fitur dan berita yang akan datang.      
    </p>

    <p v-if="userPosition" class="success">
      Rekan komunitas diurutkan berdasarkan jarak ke tempat kalian.      
    </p>
            ...
            if (
              ...
              return (
                '<span ' +
                  ...
                  'title="' +
                    vm.profile.name +
                    ' bisa memberikan seminar teknis di bahasa yang kalian inginkan.' +
                  '"' +
                '\>' + language + '</span>'
              )
            }
